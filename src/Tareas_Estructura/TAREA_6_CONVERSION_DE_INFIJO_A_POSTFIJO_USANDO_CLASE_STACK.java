...
import javax.swing.*;
import  java.util.*;
/*DESARROLLAR UN PROGRAMA EN JAVA QUE CONTENGA LAS CLASES(STACK) Y
 MÉTODOS NECESARIOS, PARA CONVERTIR UNA EXPRESIÓN DE INFIJO A POSTFIJO.
 COMO PUEDEN SER:

LEER UNA EXPRESION ALGEBRAICA EN INFIJO  EJEM (A+B/C) * (D-M)

CONVERTIRLA A POSTFIJO UTILIZANDO PILAS DE TIPO CARACTER Y
DESPUES EVALUARLA EN POSTFIJO UTILIZANDO PILAS DE PUNTOS FLOTANTE
...
EVALUAR POSTFIJO */
public class TAREA_6_CONVERSION_DE_INFIJO_A_POSTFIJO_USANDO_CLASE_STACK {
