...
public class examen_Arbol {
    ...
    public void insertar_en_arbol() {
        ...
        examen_Arbol nodo_nuevo = new examen_Arbol(numero_de_articulo, nombre_articulo, existencia, 'a');
        if (raiz == null) {
            raiz = nodo_nuevo;
        } else {
            examen_Arbol aux = raiz;
            examen_Arbol padre;
            while (true) {
                padre = aux;
    ...
    public void eliminar_De_manera_logica(examen_Arbol n, int mat) {
    ...
    public void pasar_de_arbol_a_lista_parte_2(examen_Arbol n) {
    ...
    public void pasar_de_arbol_a_lista_parte_3(examen_Arbol nuevo_nodo) {
//aqui es donde se agregan  a lista
    ...
    public void post_orden(examen_Arbol n) {
        if (n != null && n.estatus != 'b') {
            post_orden(n.izq);
            post_orden(n.der);
    ...
    public void pre_orden(examen_Arbol n) {
        if (n != null && n.estatus != 'b') {
            com = com + "Numero de articulo: " + n.numero_De_articulo + "\nNombre del articulo: " + n.nombre_del_articulo + "\nExistencia: " + n.existencia + "\n----------------------------------------------------------------------------------------\n";
            pre_orden(n.izq);
            pre_orden(n.der);
    ...
    public void orden(examen_Arbol n) {
        if (n != null && n.estatus != 'b') {
    ...
    public void consultar_nodo_arbol(examen_Arbol n, int numero_De_articulo__pa_borrar) {
        if (n != null && n.estatus != 'b') {
    ...
    public int profundidad(examen_Arbol nodo) {
        if (nodo == null) {
            return 0;
        } else {
    ...
    public void pasar_de_arbol_a_lista_linkedList(examen_Arbol n) {
        if (n != null && n.estatus != 'b') {
